 ...
 * Last Modified: 2016-04-22T14:28:10+02:00
...
class Xtento_OrderExport_Model_Output_Xsl extends Xtento_OrderExport_Model_Output_Abstract
{
    ...
    public function convertData($exportArray)
    {
        ...
        foreach ($outputFormats as $outputFormat) {
            ...
            if (($fileType == 'invoice_pdf' || $fileType == 'packingslip_pdf' || $fileType == 'creditmemo' || preg_match('/fooman\_/', $fileType) || preg_match('/aromicon\_/', $fileType)) && Mage::registry('is_test_orderexport') !== true) {
                $orderIds = array();
