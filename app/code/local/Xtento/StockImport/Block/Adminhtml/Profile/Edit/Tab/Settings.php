 ...
 * Last Modified: 2016-01-15T15:56:16+01:00
...
class Xtento_StockImport_Block_Adminhtml_Profile_Edit_Tab_Settings extends Xtento_StockImport_Block_Adminhtml_Widget_Tab
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('mark_out_of_stock', 'select', array(
            'label' => Mage::helper('xtento_stockimport')->__('If stock qty is equal or below "Qty for Item\'s Status to become Out of Stock", mark as out of stock (and mark as "In Stock" again if qty is above "Qty for Item\'s Status ...")'),
