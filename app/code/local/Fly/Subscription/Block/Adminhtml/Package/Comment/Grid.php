 ...
 */
/**
 * Subscription comments admin grid block
 *
 * @category    Fly
 * @package     Fly_Subscription
 * @author      Ultimate Module Creator
 */
class Fly_Subscription_Block_Adminhtml_Package_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Fly_Subscription_Block_Adminhtml_Package_Comment_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('fly_subscription/package_comment_package_collection');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'ct_title',
            array(
                'header'        => Mage::helper('fly_subscription')->__('Comment Title'),
                'index'         => 'ct_title',
        ...
        $this->addColumn(
            'ct_name',
            array(
                'header'        => Mage::helper('fly_subscription')->__('Poster name'),
                'index'         => 'ct_name',
        ...
        $this->addColumn(
            'ct_email',
            array(
                'header'        => Mage::helper('fly_subscription')->__('Poster email'),
                'index'         => 'ct_email',
        ...
        $this->addColumn(
            ...
            array(
                ...
                'type'          => 'options',
                'options'       => array(
                    Fly_Subscription_Model_Package_Comment::STATUS_PENDING  =>
                        Mage::helper('fly_subscription')->__('Pending'),
                    Fly_Subscription_Model_Package_Comment::STATUS_APPROVED =>
                        Mage::helper('fly_subscription')->__('Approved'),
                    Fly_Subscription_Model_Package_Comment::STATUS_REJECTED =>
                        Mage::helper('fly_subscription')->__('Rejected'),
                )
            )
        );
        $this->addColumn(
     ...
     *
     * @access public
     * @param Fly_Subscription_Model_Package_Comment
     * @return string
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access protected
     * @param Fly_Subscription_Model_Resource_Package_Comment_Collection $collection
