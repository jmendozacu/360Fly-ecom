 ...
 */
/**
 * Subscription comment list block
 *
 * @category    Fly
 * @package     Fly_Subscription
 * @author      Ultimate Module Creator
 */
class Fly_Subscription_Block_Package_Comment_List extends Mage_Core_Block_Template
{
    /**
     * initialize
     *
    ...
    public function __construct()
    {
        ...
        $comments = Mage::getResourceModel('fly_subscription/package_comment_collection')
     ...
     *
     * @access protected
     * @return Fly_Subscription_Block_Package_Comment_List
     * @author Ultimate Module Creator
     */
