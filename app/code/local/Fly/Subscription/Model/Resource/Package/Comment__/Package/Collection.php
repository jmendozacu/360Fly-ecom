 ...
 */
/**
 * Subscription comments resource collection model
 *
 * @category    Fly
 * @package     Fly_Subscription
 * @author      Ultimate Module Creator
 */
class Fly_Subscription_Model_Resource_Package_Comment_Package_Collection extends Fly_Subscription_Model_Resource_Package_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('fly_subscription/package_comment_store');
    }
     ...
     *
     * @access protected
     * @return Fly_Subscription_Model_Resource_Package_Comment_Package_Collection
     * @author Ultimate Module Creator
     */
    ...
    {
        $this->getSelect()->where('ct.package_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('fly_subscription/package_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.package_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
