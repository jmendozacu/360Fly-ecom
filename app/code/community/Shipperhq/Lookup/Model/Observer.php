...
class Shipperhq_Lookup_Model_Observer extends Mage_Core_Model_Abstract
{
    public function cartEstimateAutocomplete($observer)
    {
        if ($block = $observer->getBlock() instanceof Mage_Checkout_Block_Cart_Shipping &&
            Mage::helper('shipperhq_lookup')->isPostcodeAutocompleteEnabled()) {
