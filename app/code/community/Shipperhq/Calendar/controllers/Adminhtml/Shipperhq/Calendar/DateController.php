 ...
 */
class Shipperhq_Calendar_Adminhtml_Shipperhq_Calendar_DateController extends Mage_Adminhtml_Controller_Action
{
    /**
     ...
     * @var array
     */
    protected $_publicActions = array('dateSelect');
    
    /**
     * Selects date from request parameters
     * 
     */
